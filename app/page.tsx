  ...
  return (
    <main className="min-h-screen flex flex-col relative bg-background overflow-hidden selection:bg-primary selection:text-light">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <FadeIn delay={0.5}>
          <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-[var(--color-deep-wine)] opacity-10 rounded-full blur-[100px]" />
        </FadeIn>
        <FadeIn delay={0.8}>
          <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-[var(--color-deep-wine)] opacity-5 rounded-full blur-[100px]" />
        </FadeIn>
      </div>
